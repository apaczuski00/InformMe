package com.example.adam.myapplication.create;
...
public class CreateInformationActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.item_menu_information_list:
                Intent intent = new Intent(getApplicationContext(), InformationListActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_information_activity);
